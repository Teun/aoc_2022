...
void main(List<String> arguments) async {
  final rig = Rig(14, (raw) async {
    ...
    var yFloor = space.all.fold<int>(0, (a, v) => max(v.key.y, a)) + 2;
    drawLine(space, Coord(500 - yFloor - 10, yFloor),
        Coord(500 + yFloor + 10, yFloor));
  ...
  var allOK = await rig.testSnippet("sample", 93);
